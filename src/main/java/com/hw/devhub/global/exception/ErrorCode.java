...
public enum ErrorCode {
	...
	ALREADY_JOIN_GORUP(HttpStatus.BAD_REQUEST, "40004", "이미 가입한 모임입니다."),
	...
	GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "40407", "존재하지 않는 모임입니다."),
	...
	FULL_CAPACITY(HttpStatus.CONFLICT, "40304", "정원이 마감된 모임입니다."),
